    ...
    def compute_angles(self,quanti_trial):
        ...
        for trial in range(1,quanti_trial+1):
            ...
            for i in range(1,2):
                ...
                q1w = 0.69349998235702515
                q2x = 0.02199999988079071
                ...
                q1x = 0.021600000560283661
                q1y = -0.71979999542236328
                q1z = -0.00030000001424923539
                q1w = 0.69379997253417969
                q2x = 0.52499997615814209
                q2y = -0.49059998989105225
                q2z = -0.49439999461174011
                q2w = 0.48910000920295715
                """
                """""
                "turn left the cube of -90°"
                q1x = 0.021700000390410423
                q1y = -0.71909999847412109
                q1z = 0.0013000000035390258
                q1w = 0.69459998607635498
                q2x = -0.48609998822212219
                q2y = -0.53109997510910034
                ...
                q1z = -0.034000001847743988
                q1w = 0.70569998025894165
                q2x = -0.0024999999441206455
                ...
                q1z = 0.00039999998989515007
                q1w = 0.56180000305175781
                q2x = 0.018200000748038292
